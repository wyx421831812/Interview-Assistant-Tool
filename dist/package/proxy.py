...
例如：
  原地址：https://ark.cn-beijing.volces.com/api/plan/v3
  配置为：http://localhost:8787/proxy/https://ark.cn-beijing.volces.com/api/plan/v3
"""
...
def main():
    ...
    print(f"    火山方舟: http://localhost:{port}/proxy/https://ark.cn-beijing.volces.com/api/plan/v3")
